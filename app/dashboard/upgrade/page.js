...
const UpgradePlan = () => {
  return (
    <div>
      <h2 className="font-medium text-3xl">Upgrade</h2>
      <p>Upgrade your plan to upload multiple pdf to take notes</p>
      <div class="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-1 md:grid-cols-2 sm:items-center md:gap-8 ">
          <div class="rounded-2xl border border-indigo-600 p-6 shadow-sm ring-1 ring-indigo-600 sm:order-last sm:px-8 lg:p-12">
            ...
            <ul class="mt-6 space-y-2">
              <li class="flex items-center gap-1">
                ...
                <span class="text-gray-700"> Unlimited PDF Uploads </span>
              </li>
              ...
              <li class="flex items-center gap-1">
                ...
                <span class="text-gray-700"> Unlimited Note Taking</span>
              </li>
          ...
          <div class="rounded-2xl border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12">
            ...
            <ul class="mt-6 space-y-2">
              <li class="flex items-center gap-1">
                ...
                <span class="text-gray-700"> 5 PDF Uploads </span>
              </li>
