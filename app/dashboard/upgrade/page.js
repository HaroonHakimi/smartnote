...
const UpgradePlan = () => {
  ...
  const onPaymentSuccess = async () => {
    const result = await upgradeUserPlan({email:user?.primaryEmailAddress?.emailAddress});
    console.log(result);
  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-1 md:grid-cols-2 sm:items-center md:gap-8 ">
